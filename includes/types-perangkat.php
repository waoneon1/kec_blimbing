...
function docrt_report_page() {
    //if (current_user_can('manage_options')) {
         add_submenu_page(
            'edit.php?post_type=docrt-document',
            'Laporan',
            'Laporan',
            'read',
            'docrt-report',
...
function docrt_report_page_callback() {
    ...
    <div class="wrap">
        <h1>Laporan</h1>
        <form name="post" action="edit.php?post_type=docrt-document&page=docrt-report" method="post" id="post" autocomplete="off" target="_blank">
        ...
        <table class="wp-list-table widefat fixed striped pages laporan-tbl">
            <tbody>
                ...
                <tr>
                    ...
                    <td> : </td>
                    <td><input name="docrt_report[date_after]" type="text" class="docrt_inputs docrt_datepicker" id="docrt_date_after" value="" readonly/></td>
                </tr>
                <tr>
                    <td><strong>Sebelum Tanggal</strong></td>
                    <td> : </td>
                    <td><input name="docrt_report[date_before]" type="text" class="docrt_inputs docrt_datepicker" id="docrt_date_before" value="" readonly/></td>
                </tr>
                <tr>
...
function docrt_ttd_setting_callback() {
    ...
    <div class="wrap">
        ...
        <input type="submit" name="ttd_submit" value="SAVE" class="button-primary button-large button-fullwidth button-ttd-submit" />
        <?php
        if ($ttd) {
    ...
    <div id="data_dasar_tabs" style="display: none;">
      ...
      <div id="data_dasar_tabs-3">
        <h3 class="docrt-option-title">PENGESAH</h3>
          <div style="background-color: #0085ba; height: 4px;"></div>
          <?php $kecamatan = ucwords(isset($meta['kec']) ? $meta['kec'] : '') ?>
          ...
          <table class="docrt_tbl"><tbody class="">
              <tr align="left">
                  ...
                  <td valign="top"> : </td>
                  <td><input name="docrt_pej[0][jabatan]" type="text" class="docrt_inputs" id="docrt_pej_jabatan" value="Camat" readonly />
                      <input name="docrt_pej[0][kode]" type="hidden" value="camat" />
                  </td>
              </tr>
              <tr align="left">
